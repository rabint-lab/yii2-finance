...
/* @var $model rabint\finance\models\FinanceOfflinePaySearch */
...
<div class="card block block-rounded block-mode-loading-refresh">
    ...
    <div class="card-body block-content bg-body-light" style="display: none;">
        <div class="search_box finance-offline-pay-search">
            <div class="row">
                                <div class="col-sm-4"><?= $form->field($model, 'id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'user_id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'transaction_id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'callback') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'amount') ?></div>

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'image') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'date_pay') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'tracking_cod') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'description') ?></div>-->
