...
<div class="box-view wallet-connection-view"  id="ajaxCrudDatatable">
            ...
            <div class="card block block-rounded <?= $isModalAjax?'ajaxModalBlock':'';?> ">
                <div class="card-header block-header block-header-default">
                    ...
                    <div class="block-action float-left">
                            <?= Html::a(Yii::t('rabint', 'Create Wallet Connection'), ['create'], ['class' => 'btn btn-info btn-sm  btn-noborder']) ?>
