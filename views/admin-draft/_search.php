...
/* @var $model rabint\finance\models\FinanceDraftSearch */
...
<div class="card block block-rounded block-mode-loading-refresh">
    ...
    <div class="card-body block-content bg-body-light" style="display: none;">
        <div class="search_box finance-draft-search">
            <div class="row">
                <div class="col-sm-4"><?= $form->field($model, 'id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'user_id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'checker_id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'title') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'bank') ?></div>

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'form_id') ?></div>-->
                ...
                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'check_url') ?></div>-->
