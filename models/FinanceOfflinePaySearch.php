...
/**
 * FinanceOfflinePaySearch represents the model behind the search form about `rabint\finance\models\FinanceOfflinePay`.
 */
class FinanceOfflinePaySearch extends FinanceOfflinePay
{
    ...
    {
        return [
            [['id', 'user_id', 'transaction_id', 'date_pay', 'created_at', 'updated_at'], 'integer'],
            [['callback', 'amount', 'image', 'tracking_cod', 'description'], 'safe'],
    ...
    {
        $query = FinanceOfflinePay::find();//->alias('financeofflinepay');
        ...
        $query->andFilterWhere(['like', 'callback', $this->callback])
            ->andFilterWhere(['like', 'amount', $this->amount])
            ->andFilterWhere(['like', 'image', $this->image])
            ->andFilterWhere(['like', 'tracking_cod', $this->tracking_cod])
